...
class MockData {
    ...
    init {
        ...
        PLACE_IMAGES.shuffle()
        FOOD_IMAGES.shuffle()

        placesList = (1..15).map { Place(
            id = it,
            name = faker.company().name(),
            address = faker.address().streetAddress(),
            mainImage = PLACE_IMAGES[it % PLACE_IMAGES.size],
            gallery = (1..15).map { image -> PLACE_IMAGES[image % PLACE_IMAGES.size] },
            categories = foodList
        )} as MutableList<Place>

        foodList = (1..30).map { Food(
            foodCategory = faker.food().dish(),
            foodName = faker.food().ingredient(),
            foodPrice = (1000..20000).random(),
            foodDesc = faker.lorem().characters(20),
            foodImage = FOOD_IMAGES[it % FOOD_IMAGES.size]
        )} as MutableList<Food>
    }

    companion object {
        private val PLACE_IMAGES = mutableListOf(
            ...
            "https://images.unsplash.com/photo-1529676468696-f3a47aba7d5d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80",
            "https://images.unsplash.com/photo-1569096651661-820d0de8b4ab?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=663&q=80",
            ...
            "https://images.unsplash.com/photo-1586253181808-c030e7e1aa5e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80",
            ...
            "https://images.unsplash.com/photo-1553365857-9cc1a715084f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=970&q=80",
            "https://images.unsplash.com/photo-1565955374207-218b185516a9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
            "https://images.unsplash.com/photo-1593716245758-8d68944830c3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80",
            ...
            "https://images.unsplash.com/photo-1578245314285-e55ab9ee31c0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80",
            "https://images.unsplash.com/photo-1619474387533-301ed3b5a734?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=765&q=80"
        )

        private val FOOD_IMAGES = mutableListOf(
